...
# Importar Nivel 2
from nivel2 import main_nivel2
...
pygame.display.set_caption("CyberGuardian - Nivel 1")
...
def draw_hud(surface, player, challenge_done):
    ...
    # -------------------------------------
    obj_rect = pygame.Rect(225, 18, 720, 52)
    ...
    if challenge_done:
        ...
        border = YELLOW
        fill = (34, 22, 8)
        objective = "Resuelve el reto de phishing para abrir la puerta."
...
# RETO DE PHISHING
# =========================================
def phishing_challenge(screen_surface):
    local_clock = pygame.time.Clock()
    font_title = pygame.font.Font(None, 58)
    font = pygame.font.Font(None, 34)
    font_small = pygame.font.Font(None, 28)

    question = "¿Cual de estos correos es un intento de phishing?"
    options = [
        "1) soporte@banco-colombia.com",
        "2) info@universidad.edu.co",
        "3) seguridad@banc0-colombia.com"
    ]
    correct = 3
    ...
    while True:
        ...
        title = font_title.render("RETO DE PHISHING", True, CYAN)
...
def create_vertical_level():
    ...
    P(80, HEIGHT - 140, 1170, 24)
    P(500, HEIGHT - 230, 180, 24)
    P(80, HEIGHT - 300, 300, 24)
    P(500, HEIGHT - 380, 200, 24)
    P(650, HEIGHT - 460, 200, 24)
    P(750, HEIGHT - 520, 200, 24)
...
# =========================================
# PANTALLA FINAL NIVEL 1
# =========================================
def level_complete_screen(screen_surface):
    local_clock = pygame.time.Clock()
    font_title = pygame.font.Font(None, 60)
    font_btn = pygame.font.Font(None, 40)

    atlas_path = asset_path("assets", "sprites", "Atlas", "Fin_nivel1.png")
    atlas_background = load_image_safe(atlas_path, (WIDTH, HEIGHT), alpha=True)

    font_msg = pygame.font.Font(None, 34)
    ...
    text1 = "¡Muy bien Cyber!"
    text2 = "Superaste tu primer reto del mundo digital."
    ...
    while True:
        ...
        screen_surface.blit(atlas_background, (0, 0))

        overlay = pygame.Surface((WIDTH, HEIGHT), pygame.SRCALPHA)
        overlay.fill((0, 0, 0, 130))
        screen_surface.blit(overlay, (0, 0))

        title = font_title.render("¡NIVEL 1 COMPLETADO!", True, CYAN)
        screen_surface.blit(title, (WIDTH // 2 - title.get_width() // 2, 60))

        screen_surface.blit(font_msg.render(text1, True, WHITE), (WIDTH // 2 - 220, 200))
        screen_surface.blit(font_msg.render(text2, True, WHITE), (WIDTH // 2 - 300, 240))
...
# =========================================
def main_nivel1():
    music_path = asset_path("assets", "Musica", "Nivel1.mp3")
    ...
    if os.path.exists(music_path):
        ...
        print(f"No se encontró la música del nivel 1: {music_path}")

    fondo = ParallaxBackground(
        asset_path("assets", "sprites", "Fondos", "Nivel1", "CAPA1.png"),
        asset_path("assets", "sprites", "Fondos", "Nivel1", "CAPA2.png")
    )
    ...
    while running:
            ...
            if e.type == pygame.KEYDOWN:
                if e.key == pygame.K_e and terminal.can_interact(player.rect):
                    if not challenge_done:
                        success = phishing_challenge(screen)
        ...
        # HUD compacto sin panel de terminal
        ...
        if door.can_exit(player, challenge_done):
            ...
            result = level_complete_screen(screen)
